...
class Monster:
    ...
    def __init__(self):
        ...
        self.monBgm = load_wav('sound//gbn_dmg_02.ogg')
        self.monDie = load_wav('sound//gbn_die_02.ogg')
        self.monBgm.set_volume(64)
        self.monDie.set_volume(64)
...
class Boy:
    def __init__(self):
        ...
        self.boySkill1 = load_wav('sound//sm_congestion.ogg')
        self.boyDie = load_wav('sound//sm_die.ogg')
        self.boySkill1.set_volume(64)
        self.boySkill2.set_volume(64)
        self.boySkill3.set_volume(64)
        self.boyDie.set_volume(64)
            ...
            for i in range(SKILL_MAXNUM):
                if(skill[i].size == skill[i].skillNum):
                    ...
                    if boy.State == STATE_IDLE or boy.State == STATE_MOVE:
                        ...
                        if boy.State == STATE_SKILL1:
                            boy.boySkill1.play()
                        elif boy.State == STATE_SKILL2:
                            boy.boySkill2.play()
                        elif boy.State == STATE_SKILL3:
                            boy.boySkill3.play()
